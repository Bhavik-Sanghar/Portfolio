        ...
        <Row>
          <Col lg={6} md={12} className={`animated-item ${isVisible ? 'fade-in' : ''}`}>
            <div className="about-image">
              <img src="your-image-path.jpg" alt="About Me" className="rounded-image" />
            </div>
          </Col>
          <Col lg={6} md={12} className={`animated-item ${isVisible ? 'fade-in' : ''}`}>
            <div className="about-content">
              <h3 className="about-title">Web Developer by Day,</h3>
              <h3 className="about-title">Batman by Night</h3>
